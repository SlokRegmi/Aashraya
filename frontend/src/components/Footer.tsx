        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted platform for finding the perfect room rental. 
              Connecting tenants and landlords across the country.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Browse Rooms</a></li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">123 Main Street, NY 10001</span>
              </div>
              <div className="flex items-center space-x-2">
